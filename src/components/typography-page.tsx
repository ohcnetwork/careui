    ...
    <DocumentationPage>
        ...
        <section>
          ...
          <DocumentationParagraph spacing="stack">
            ...
            <InlineCode>src/index.css</InlineCode>. The root font size scales
        ...
        <section>
          ...
          <article className="border-border bg-card mt-6 rounded-lg border p-6 md:p-8">
            ...
            <p className="text-foreground mt-1 text-sm leading-6">
              Three medications and two investigations are active. No
              interactions flagged by pharmacy.
            </p>
          ...
          <div className="border-border bg-muted/40 mt-6 rounded-lg border p-5">
            <p className="text-foreground text-sm leading-6">
              ...
              clinical surfaces still put data above the fold. H1 is{" "}
          ...
          <div className="border-border mt-6 rounded-lg border">
            ...
            >
              <p className="text-foreground leading-7">
                ...
                follow-up scheduled for the outpatient department next week.
                Medication reconciliation was completed at the bedside.
              </p>
            </SpecRow>
        ...
        <section>
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="border-border bg-card rounded-lg border p-6 md:p-8">
              ...
              <p className="text-muted-foreground mt-2 text-sm leading-6">
                Timers, countdowns, vitals refresh, and progress percentages
