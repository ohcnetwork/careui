...
class CharacterEngine {
  ...
  buildGuides() {
    ...
    bounds.setAttribute("x", String(36.73 - G.RX));
    bounds.setAttribute("y", String(45.09 - G.RY));
    bounds.setAttribute("width", String(75.18 + 8 - 36.73 + 2 * G.RX));
    bounds.setAttribute("height", String(8 + 2 * G.RY));
    ...
    for (const pts of [
      ...
      l.setAttribute("x1", String(59.955 + pts[0]));
      l.setAttribute("y1", String(49.09 + pts[1]));
      l.setAttribute("x2", String(59.955 + pts[2]));
      l.setAttribute("y2", String(49.09 + pts[3]));
  ...
  render() {
    ...
    this.mL.setAttribute("visibility", cvis);
    this.mR.setAttribute("visibility", cvis);
    const cornerLift = 0;
  ...
  return (
    <div className={cn("text-foreground", className)} {...props}>
      ...
      <svg
        ...
        className="mx-auto block h-auto w-24"
      >
        <g data-part="head">
          <path
            data-part="face"
