  ...
  "inline-flex items-center justify-center gap-1.5 px-3 whitespace-nowrap rounded-sm border border-transparent bg-clip-padding text-sm font-semibold tracking-wide outline-0 select-none shrink-0 transition-[background-color,border-color,color,box-shadow,transform,opacity,outline,outline-offset] touch-action-manipulation [-webkit-tap-highlight-color:transparent] group/button [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-5 disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 aria-invalid:outline-2 aria-invalid:outline-offset-2 aria-invalid:outline-destructive ",
  {
    variants: {
      variant: {
        ...
        link: "text-blue-700 underline underline-offset-4 transition-[color,text-underline-offset] hover:underline-offset-2 hover:text-blue-800 [:active,[data-pressed]]:text-blue-900 [:active,[data-pressed]]:underline-offset-[3px] dark:text-blue-400 dark:hover:text-blue-300 dark:[:active,[data-pressed]]:text-blue-200",
      },
      size: {
        default:
        ...
        icon: "size-10 min-w-[44px] min-h-[44px] [&_svg:not([class*='size-'])]:size-5",
        "icon-xs":
        ...
        "icon-lg": "size-11 min-w-[44px] min-h-[44px] [&_svg:not([class*='size-'])]:size-5",
        "icon-xl": "size-12 min-w-[44px] min-h-[44px] [&_svg:not([class*='size-'])]:size-6",
      },
    },
    defaultVariants: {
      variant: "default",
