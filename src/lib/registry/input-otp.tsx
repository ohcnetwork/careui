...
export const inputOtpDoc: ComponentDoc = {
    ...
    installation: {
      ...
      manual: 'Install input-otp dependency and copy the input-otp component source code into your project.'
    },
    usage: `import {
  InputOTP,
  InputOTPGroup,
...
<InputOTP maxLength={6}>
  ...
  <InputOTPGroup>
    ...
    <InputOTPSlot index={5} />
      ...
      component: React.createElement(InputOTP as any, { maxLength: 6 },
        React.createElement(InputOTPGroup, {},
  ...
  <InputOTPGroup>
    ...
    <InputOTPSlot index={3} />
        ...
        preview: React.createElement(InputOTP as any, { maxLength: 4 },
          React.createElement(InputOTPGroup, {},
            React.createElement(InputOTPSlot, { index: 0 }),
            React.createElement(InputOTPSlot, { index: 1 }),
            React.createElement(InputOTPSlot, { index: 2 }),
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="text-center text-sm">
        ...
        preview: React.createElement('div', { className: 'space-y-2' },
          React.createElement(InputOTP as any, { maxLength: 6 },
            React.createElement(InputOTPGroup, {},
              React.createElement(InputOTPSlot, { index: 0 }),
              React.createElement(InputOTPSlot, { index: 1 }),
              React.createElement(InputOTPSlot, { index: 2 }),
          ...
          React.createElement('div', { className: 'text-center text-sm' }, 'Enter your one-time password.')
        )
      }
    ],
    props: [
