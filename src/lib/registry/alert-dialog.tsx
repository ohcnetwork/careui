...
export const alertDialogDoc: ComponentDoc = {
    ...
    installation: {
      ...
      manual: 'Copy and paste the alert dialog component source code into your project.'
    },
      ...
      component: React.createElement(AlertDialog, {},
        ...
        React.createElement(AlertDialogContent, {},
          React.createElement(AlertDialogHeader, {},
            ...
            React.createElement(AlertDialogDescription, {}, 'This action cannot be undone. This will permanently delete your data.')
          ),
