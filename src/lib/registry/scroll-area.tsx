...
export const scrollAreaDoc: ComponentDoc = {
    ...
    installation: {
      ...
      manual: 'Copy and paste the scroll area component source code into your project.'
    },
  ...
  <div>Content...</div>
      ...
      component: React.createElement(ScrollArea, { className: 'h-72 w-48 rounded-md border' },
        React.createElement('div', { className: 'p-4' },
          React.createElement('h4', { className: 'mb-4 text-sm font-medium leading-none' }, 'Tags'),
          ['v1.0.0', 'v1.1.0', 'v1.2.0', 'v2.0.0', 'v2.1.0'].map((tag, i) =>
            React.createElement('div', { key: tag },
