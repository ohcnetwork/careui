...
export const badgeDoc: ComponentDoc = {
  id: 'badge',
  name: 'Badge',
  description: 'A badge component for displaying small bits of information like status, labels, or notifications.',
  installation: {
...
export function BadgeDemo() {
  ...
  <Badge variant="outline">Outline</Badge>
    ...
    component: React.createElement('div', { className: 'flex items-center gap-2 flex-wrap' },
  ...
  <Badge variant="outline">Pending</Badge>
      ...
      preview: React.createElement('div', { className: 'flex items-center gap-2 flex-wrap' },
