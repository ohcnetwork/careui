...
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem, CommandSeparator, CommandDialog, CommandShortcut } from '@/components/ui/command'
...
export const commandDoc: ComponentDoc = {
    ...
    installation: {
      ...
      manual: 'Copy and paste the command component source code into your project.'
    },
    usage: `import {
  Calculator,
  Calendar,
...
export function CommandDemo() {
  ...
  <CommandList>
    ...
    <CommandGroup heading="Settings">
      ...
      component: React.createElement(Command, { className: "rounded-lg border shadow-md md:min-w-[450px]" },
        ...
        React.createElement(CommandList, {},
          ...
          React.createElement(CommandGroup, { heading: "Suggestions" },
            ...
            React.createElement(CommandItem, { disabled: true },
              React.createElement(Calculator, {}),
              React.createElement('span', {}, "Calculator")
            )
          ),
          React.createElement(CommandSeparator),
          React.createElement(CommandGroup, { heading: "Settings" },
            React.createElement(CommandItem, {},
        ...
        preview: React.createElement(() => {
          ...
          return React.createElement("div", { className: "flex flex-col items-center space-y-4" },
            ...
            React.createElement(CommandDialog, { open: open, onOpenChange: setOpen },
              React.createElement(Command, { className: "rounded-lg border-0 shadow-none" },
                React.createElement(CommandInput, { placeholder: "Type a command or search..." }),
                React.createElement(CommandList, {},
                  React.createElement(CommandEmpty, {}, "No results found."),
                  React.createElement(CommandGroup, { heading: "Suggestions" },
  ...
  <CommandList>
    ...
    <CommandGroup heading="Actions">
      ...
      <CommandItem>
        ...
        preview: React.createElement(Command, { className: "rounded-lg border shadow-md max-w-md" },
          React.createElement(CommandInput, { placeholder: "Search commands..." }),
          React.createElement(CommandList, {},
            React.createElement(CommandEmpty, {}, "No results found."),
            React.createElement(CommandGroup, { heading: "Navigation" },
              React.createElement(CommandItem, {},
                "Dashboard",
    ...
    props: [
      ...
      },
      {
        name: 'shouldFilter',
        type: 'boolean',
        description: 'Whether the command should filter items based on the search value.',
        default: 'true'
      },
      {
        name: 'filter',
