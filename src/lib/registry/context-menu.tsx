...
export const contextMenuDoc: ComponentDoc = {
    ...
    installation: {
      ...
      manual: 'Copy and paste the context menu component source code into your project.'
    },
  ...
  <ContextMenuContent>
    ...
    <ContextMenuItem>Item 2</ContextMenuItem>
      ...
      component: React.createElement(ContextMenu, {},
        React.createElement(ContextMenuTrigger, { className: 'flex h-[150px] w-[300px] items-center justify-center rounded-md border border-dashed text-sm' },
          'Right click here'
        ),
        React.createElement(ContextMenuContent, { className: 'w-64' },
