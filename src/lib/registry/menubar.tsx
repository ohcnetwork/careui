...
export const menubarDoc: ComponentDoc = {
    ...
    installation: {
      ...
      manual: 'Copy and paste the menubar component source code into your project.'
    },
  ...
  <MenubarMenu>
    ...
    <MenubarContent>
      ...
      component: React.createElement(Menubar, {},
        React.createElement(MenubarMenu, {},
          React.createElement(MenubarTrigger, {}, 'File'),
          React.createElement(MenubarContent, {},
