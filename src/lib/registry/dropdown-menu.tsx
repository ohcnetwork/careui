...
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuGroup, DropdownMenuCheckboxItem, DropdownMenuRadioGroup, DropdownMenuRadioItem, DropdownMenuSub, DropdownMenuSubTrigger, DropdownMenuSubContent } from '@/components/ui/dropdown-menu'
...
export const dropdownMenuDoc: ComponentDoc = {
    ...
    installation: {
      ...
      manual: 'Install @radix-ui/react-dropdown-menu dependency and copy the dropdown menu component source code into your project.'
    },
    usage: `"use client"
...
export function DropdownMenuDemo() {
  ...
  <DropdownMenuContent>
    ...
    <DropdownMenuItem>Logout</DropdownMenuItem>
      ...
      component: React.createElement(DropdownMenu, {},
      ...
      Panel
        ...
        preview: React.createElement(DropdownMenu, {},
          ...
          React.createElement(DropdownMenuContent, {},
            ...
            React.createElement(DropdownMenuSeparator, {}),
            React.createElement(DropdownMenuCheckboxItem, { checked: true }, 'Status Bar'),
            React.createElement(DropdownMenuCheckboxItem, {}, 'Activity Bar'),
            React.createElement(DropdownMenuCheckboxItem, { checked: true }, 'Panel')
          )
        )
      },
      {
        name: 'With Radio Items',
        description: 'A dropdown menu with radio button items for single selection.',
        code: `<DropdownMenu>
  <DropdownMenuTrigger asChild>
      ...
      <DropdownMenuRadioItem value="system">
        ...
        preview: React.createElement(DropdownMenu, {},
          ...
          React.createElement(DropdownMenuContent, {},
            ...
            React.createElement(DropdownMenuSeparator, {}),
            React.createElement(DropdownMenuRadioGroup, { value: 'light' },
              React.createElement(DropdownMenuRadioItem, { value: 'light' }, 'Light'),
              React.createElement(DropdownMenuRadioItem, { value: 'dark' }, 'Dark'),
              React.createElement(DropdownMenuRadioItem, { value: 'system' }, 'System')
            )
          )
        )
      },
    ...
    <DropdownMenuItem>Print</DropdownMenuItem>
        ...
        preview: React.createElement(DropdownMenu, {},
          ...
          React.createElement(DropdownMenuContent, {},
            ...
            React.createElement(DropdownMenuSub, {},
              React.createElement(DropdownMenuSubTrigger, {}, 'Share'),
              React.createElement(DropdownMenuSubContent, {},
