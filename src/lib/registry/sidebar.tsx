...
const NavMain = ({ items }: { items: typeof sampleData.navMain }) => (
  <SidebarGroup>
...
const NavProjects = ({
  ...
  projects: typeof sampleData.projects;
}) => {
  const { isMobile } = useSidebar();
  return (
...
const NavUser = ({ user }: { user: typeof sampleData.user }) => {
  const { isMobile } = useSidebar();
  return (
    <SidebarMenu>
      <SidebarMenuItem>
  ...
  <SidebarProvider className="min-h-125">
    ...
    <SidebarInset>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        <div className="min-h-50 flex-1 rounded-xl bg-muted/50" />
      </div>
    </SidebarInset>
  </SidebarProvider>
);
...
export const sidebarDoc: ComponentDoc = {
  ...
  installation: {
    ...
    manual: "Install radix-ui, class-variance-authority and copy the sidebar component source code.",
  },
...
import {
  AudioWaveform, BadgeCheck, Bell, BookOpen, Bot, ChevronRight, ChevronsUpDown,
  Command, CreditCard, Folder, Forward, Frame, GalleryVerticalEnd, LogOut, Map,
  MoreHorizontal, PieChart, Plus, Settings2, Sparkles, SquareTerminal, Trash2,
} from "lucide-react"
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  return (
    ...
    component: React.createElement(AppSidebarPreview),
  },
};
