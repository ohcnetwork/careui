...
export const inputGroupDoc: ComponentDoc = {
    ...
    installation: {
      ...
      manual: 'Copy and paste the input group component source code into your project.'
    },
  ...
  <InputGroupAddon align="inline-end">.00</InputGroupAddon>
      ...
      component: React.createElement(InputGroup, {},
        React.createElement(InputGroupAddon, { align: 'inline-start' }, '$'),
        React.createElement(InputGroupInput, { type: 'number', placeholder: '0' }),
